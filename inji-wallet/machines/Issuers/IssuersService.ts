...
async function sendTokenRequest(
  ...
  console.log("========== TOKEN REQUEST OBJECT ==========");
  console.log(JSON.stringify(tokenRequestObject, null, 2));
  ...
  console.log("TOKEN ENDPOINT:", tokenRequestObject.tokenEndpoint);
  console.log("TOKEN REQUEST BODY:", formBody.toString());
