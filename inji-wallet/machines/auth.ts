...
export const authMachine = model.createMachine(
    ...
    states: {
      ...
      checkingAuth: {
        always: [
          ...
          {cond: 'hasFaceEnrolled', target: 'unauthorized'},
      ...
      settingUp: {
        on: {
          ...
          SETUP_FACE: {
             target: 'authorized',
             actions: ['setFaceEnrolled', 'setLanguage', 'setAppSetupComplete', 'storeContext'],
            },
        },
      },
      unauthorized: {
  ...
  },
  {
    ...
    guards: {
      ...
      hasFaceEnrolled: context => context.faceEnrolled === true,
