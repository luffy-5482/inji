...
const AppInitialization: React.FC = () => {
  ...
  // 🔥 PRELOAD FACE MODEL ONCE WHEN APP STARTS
  useEffect(() => {
    try {
      if (NativeModules?.BiometricBridge?.preloadFace) {
        NativeModules.BiometricBridge.preloadFace();
      }
    } catch (e) {
      console.log('Face preload failed:', e);
    }
  }, []);

  // Existing keystore popup logic
  useEffect(() => {
